...
class BlogList(models.Model):
    ...
    creator = models.ForeignKey(to=User, related_name='u_b', null=True, blank=True)
    ...
    blog_kind = models.ForeignKey("BlogKind", verbose_name="blog kind select", default=1)
...
class MessageList(models.Model):
    ...
    creator = models.ForeignKey(to=User, related_name='u_m', null=True, blank=True)
    create_date = models.DateTimeField()
    adjustment_date = models.DateTimeField(null=True, blank=True)
